...
export const INCREASE_CART_ITEM_WEIGHT_REQUEST = 'INCREASE_CART_ITEM_WEIGHT_REQUEST';
export const INCREASE_CART_ITEM_WEIGHT_SUCCESS = 'INCREASE_CART_ITEM_WEIGHT_SUCCESS';
export const INCREASE_CART_ITEM_WEIGHT_FAILURE = 'INCREASE_CART_ITEM_WEIGHT_FAILURE';

export const DECREASE_CART_ITEM_WEIGHT_REQUEST = 'DECREASE_CART_ITEM_WEIGHT_REQUEST';
export const DECREASE_CART_ITEM_WEIGHT_SUCCESS = 'DECREASE_CART_ITEM_WEIGHT_SUCCESS';
export const DECREASE_CART_ITEM_WEIGHT_FAILURE = 'DECREASE_CART_ITEM_WEIGHT_FAILURE';
