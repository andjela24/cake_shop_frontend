...
const orderStatus = [
  { label: "U transportu", value: "onTheWay" },
  { label: "Dostavljena", value: "delevered" },
  { label: "Otkazana", value: "cancelled" },
  { label: "Vraćena", vlue: "returned" },
];
...
const Order = () => {
  ...
  // const order = useSelector((store) => store.customerOrder.order);
